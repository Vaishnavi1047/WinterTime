    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* BEE Compliance Warning */}
          <div className="mt-8 p-4 border border-yellow-500/20 bg-yellow-500/5 rounded-lg">
            <h4 className="text-yellow-400 text-sm font-bold mb-1">Compliance Warning</h4>
            <p className="text-slate-400 text-xs">
              Modifying the Industry Sector or Compliance Target during an active trading cycle may trigger a BEE audit. Ensure all changes are verified by your designated energy auditor.
            </p>
          </div>
